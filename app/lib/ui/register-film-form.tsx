...
export default function RegisterFilmForm() {
    ...
    return (
        <form action={registerFilme} className={`rounded-sm ${toggleState} h-[204px] flex flex-row items-center justify-start overflow-clip`}>
            <div onClick={handleClick} className="flex-none group w-[136px] h-[204px] flex items-center justify-center">
                <svg className="dark:fill-white" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 0 24 24" width="40px" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"/></svg>
            </div>
